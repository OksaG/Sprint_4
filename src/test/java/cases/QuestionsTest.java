...
public class QuestionsTest extends BaseTest {
    ...
    public QuestionsTest(String answerText, int accordionIdNumber) {
        this.answerText = answerText;
        this.accordionIdNumber = accordionIdNumber;
    }
    ...
    public void questionsTest() {
        ...
        //кликнуть на вопрос
        String text = homePage.getAnswer(accordionIdNumber);
        Assert.assertEquals("Текст ответа на вопрос не совпадает с ожидаемым", answerText, text);
    }
}
